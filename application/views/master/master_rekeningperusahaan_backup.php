            ...
            <div class="modal-body">
                <form id="form">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="recipient-name" name="id_perusahaan">
                        <input type="hidden" name="id">
                    </div>

                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">Nomor Rekening Bank Cabang:</label>
                        <input type="text" class="form-control" id="recipient-name" name="id_rek_bankbranch">
                        <input type="hidden" name="id">
                    </div>
                </form>
            </div>
...
function edit_data(id) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $('#modal').modal('show'); // show bootstrap modal when complete loaded
            $('.modal-title').text('Update rekeningperusahaan'); // Set title to Bootstrap modal title
