...
function edit_data(id) {
    ...
    $.ajax({
        url: "<?php echo site_url('master/getperusahaan_byid/')?>" + id,
        type: "GET",
        dataType: "JSON",
        beforeSend: function() {
            Swal.fire({
...
function save() {
    var url;
    if (save_method == 'add') {
        url = "<?php echo site_url('master/perusahaan_add')?>";
    } else {
        url = "<?php echo site_url('master/perusahaan_update')?>/" + $('input[name="id"]').val();
    }
    Swal.fire({
        title: 'Are you sure?',
...
function delete_data(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "<?php echo site_url('master/perusahaan_delete/') ;?>" + id,
                type: "POST",
                dataType: "JSON",
                 beforeSend: function() {
                    Swal.fire({
