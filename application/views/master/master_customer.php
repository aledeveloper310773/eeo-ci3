                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="brand" name="id_brand">
                                    <option value=""></option>
                                    <?php foreach ($brand as $value) {
                                     echo '<option value="'.$value->id.'">'.$value->kode_brand.'-'.$value->nama_brand.'-'.$value->nama_jenis.'</option>';
                                        } ;?>
                                </select>
                            </div>
                        </div>
...
function edit_data(id) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $('#brand').val(data.id_brand).change();
            $('#modal').modal('show'); // show bootstrap modal when complete loaded
